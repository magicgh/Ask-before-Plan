...
from tools.utils import extract_from_to, get_valid_name_city
            ...
            if 'flight number' in value.lower():
                    try:
                        ...
                        if len(res) > 0:
                            ...
                            returned_info.append('The flight information is not valid.')
                    except:
                        returned_info.append('The flight information is not valid.')
                ...
                try:
                    if 'self-driving' in value.lower():
                        ...
                        if cost == None:
                            returned_info.append('The transportation information is not valid, please check.')
                        else:
                    ...
                    returned_info.append('The transportation information is not valid, please check. You have to make sure there are two cities (from A to B) in your transportation plan.')
        ...
        if 'breakfast' in unit and unit['breakfast'] and unit['breakfast'] != '-':
            ...
            if name != '-' and city != '-':
                ...
                if len(res) > 0:
                    ...
                    returned_info.append('The breakfast information is not valid, please check.')
